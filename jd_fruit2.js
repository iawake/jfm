...
let shareCodes = [ // 这个列表填入你要助力的好友的shareCode
  ...
  'caaa869cc54644d8b7d2b4a5ec86cc9e@45555535b3ce2bc026438559@caaa865555d2b4a5ec86cc9e',
  //账号二的好友shareCode,不同好友的shareCode中间用@符号隔开
  'caaa869cc54644d8b7d2b4a5ec86cc9e@46f565554635b3ce2bc026438559@caaa8695553232b4a5ec86cc9e',
]
let message = '', subTitle = '', option = {}, isFruitFinished = false;
const retainWater=2000000;//保留水滴大于多少g,默认100g;
...
function readShareCode() {
  return new Promise(resolve => {
    $.get({url: `http://api.turinglabs/api/v1/jd/farm/read/${randomCount}/`}, (err, resp, data) => {
      try {
        if (err) {
          console.log(`${JSON.stringify(err)}`)
